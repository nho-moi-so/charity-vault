...
export const fundAPI = {
  ...
  // Tạo quỹ mới
  create: (data) => api.post("/funds/create", data),
...
export const donationAPI = {
  ...
  getUserHistory: (address, params = {}) =>
    api.get(`/donations/user/${address}`, { params }),

  // Lấy lịch sử giao dịch của quỹ
  getFundHistory: (fundId, params = {}) =>
    api.get(`/donations/fund/${fundId}`, { params }),
};
